...
public abstract class SvcFluxorComponentBase : SvcComponentBase, ISvcFluxorComponentSubscriber
{
    #region Injects
    ...
    // Blazor 
    [Inject] protected InternalApiUrlMapper _backendUrlMapper { get; init; } = null!;
