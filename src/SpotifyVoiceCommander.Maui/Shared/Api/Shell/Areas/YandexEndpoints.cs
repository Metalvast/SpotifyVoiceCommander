...
{
    public Task<ErrorOr<RecognizeSpeechResponse>> RecognizeSpeechAsync(RecognizeSpeechRequest request, CancellationToken ct = default) =>
    ...
    public Task<ErrorOr<AnalyzeSpeechResponse>> AnalyzeSpeechAsync(AnalyzeSpeechRequest request, CancellationToken ct = default) =>
